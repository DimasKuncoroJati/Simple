			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<?php echo form_open('home/tambahproduk', ['class' => 'form-horizontal', 'method' => 'post']); ?>
						<div class="form-group <?php echo (form_error('kdproduk') != '') ? 'has-error has-feedback' : '' ?>">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="kdproduk" value="<?php echo set_value('kdproduk'); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="nama_produk" value="<?php echo set_value('nama_produk'); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="kategori_id" value="<?php echo set_value('kategori_id'); ?>">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="status_id" value="<?php echo set_value('status_id'); ?>">
